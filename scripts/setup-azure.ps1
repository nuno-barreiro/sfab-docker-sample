...
az sf cluster create -g $resourceGroupName -l $location `
    --certificate-output-folder ..\certificates --certificate-password $certPassword --certificate-subject-name $certSubject `
    --cluster-name $clusterName --cluster-size $clusterSize --os UbuntuServer1604 `
